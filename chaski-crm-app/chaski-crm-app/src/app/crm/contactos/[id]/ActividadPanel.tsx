...
export default function ActividadPanel({ contactoId, actividades }: { contactoId: string; actividades: Actividad[] }) {
  ...
  const colorTipo: Record<string, string> = {
    ...
    LLAMADA: "border-brand-400",
    CORREO: "border-gold-400",
    REUNION: "border-emerald-400",
  };
    ...
    <div className="bg-white border border-border rounded-2xl p-5 shadow-sm">
      ...
      <div className="space-y-3">
        {actividades.map((a) => {
          ...
          return (
            <div key={a.id} className={`border-l-2 ${colorTipo[a.tipo] || "border-gray-200"} pl-3 text-sm`}>
              <p>
